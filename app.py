...
# These values are displayed automatically when the

# ATLICE calculator is opened.
...
# Change this text when the programmed default values are

# changed again. It forces Streamlit to load the new defaults

# once instead of retaining values from an older session.
...
"""Return the application to the original landing screen."""
...
"""Restore engineering inputs without returning to the landing screen."""
...
def render_progress():
"""Display the three input stages and current status."""
...
st.markdown(
""" <div class="section-card"> <h2 style="
             margin-top:0;
             color:#153f51;
         ">
1. Cooling and ACH </h2>
...
```
        ...
        ">
            ...
            Change them only when required, then confirm
            the section before continuing.
        </p>
    </div>
    """,
    unsafe_allow_html=True,
...
with st.form("cooling_ach_form"):
    ...
    with col1:
        st.number_input(
            ...
            step=0.5,
            key="room_volume",
            help="Default ATLICE room volume: 63.5 m³.",
        )
        ...
        st.number_input(
            ...
            step=1,
            key="people",
            help="Default occupancy: 6 people.",
        )
        ...
        st.number_input(
            ...
            step=5.0,
            key="heat_per_person",
            help="Default sensible heat load: 100 W/person.",
        )
    ...
    with col2:
        st.number_input(
            ...
            step=0.5,
            key="supply_temp",
            help="Default supply temperature: 12°C.",
        )
        ...
        st.number_input(
            ...
            step=0.5,
            key="target_temp",
            help="Default target temperature: 22°C.",
        )
...
```
        <p style="
            ...
            margin-bottom:0;
        ">
            Default buoyancy and airflow values are
            already loaded. Adjust them when measured
...
with st.form("richardson_form"):
    ...
    with col1:
        st.number_input(
            ...
            step=0.01,
            key="gravity",
            help="Default reference value: 9.81 m/s².",
        )
        ...
        st.number_input(
            ...
            format="%.5f",
            key="alpha",
            help="Default approximate value: 0.00340 K⁻¹.",
        )
        ...
        st.number_input(
            ...
            step=0.1,
            key="delta_t_ri",
            help="Default Richardson-number ΔT: 5 K.",
        )
    ...
    with col2:
        st.number_input(
            ...
            step=0.1,
            key="length_scale",
            help="Default characteristic length: 1.0 m.",
        )
        ...
        st.number_input(
            ...
            format="%.3f",
            key="air_velocity",
            help="Default velocity: 0.10 m/s.",
        )
...
""" <div class="section-card"> <h2 style="
             ...
             color:#153f51;
         ">
3. Ventilation and Infection Risk </h2>
...
```
        <p style="
            ...
            margin-bottom:0;
        ">
            Default ventilation-effectiveness and
            Wells–Riley exposure parameters are already
            loaded. Replace them with the selected
            experimental scenario when required.
        </p>
    </div>
    """,
    unsafe_allow_html=True,
...
with st.form("infection_risk_form"):
    ...
    with col1:
        st.number_input(
            ...
            help="Default local ventilation effectiveness: 0.67.",
        )
        ...
        st.number_input(
            ...
            step=1,
            key="infected_people",
            help="Default value: 1 infectious person.",
        )
        ...
        st.number_input(
            ...
            step=1.0,
            key="quanta_rate",
            help="Default scenario value: 10 quanta/h.",
        )
    ...
    with col2:
        st.number_input(
            ...
            step=0.1,
            key="breathing_rate",
            help="Default sedentary breathing rate: 0.5 m³/h.",
        )
        ...
        st.number_input(
            ...
            step=0.5,
            key="exposure_time",
            help="Default exposure duration: 2 hours.",
        )
    ...
    st.markdown(
        ...
        <div class="section-card">
            ...
            <div class="review-value">
                {st.session_state.room_volume:.2f} m³
            </div>
            ...
            <div class="review-value">
                {st.session_state.heat_per_person:.2f}
                W/person
            </div>
            ...
            <div class="review-value">
                {st.session_state.supply_temp:.2f} /
                {st.session_state.target_temp:.2f} °C
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
with review2:
    ...
    st.markdown(
        ...
        <div class="section-card">
            ...
            <div class="review-value">
                {st.session_state.gravity:.2f} m/s²
            </div>
            ...
            <div class="review-value">
                {st.session_state.delta_t_ri:.2f} K
            </div>
...
with review3:
    ...
    st.markdown(
        ...
        <div class="section-card">
            ...
            <div class="review-value">
                {st.session_state.quanta_rate:.2f}
                quanta/h
            </div>
            ...
            <div class="review-value">
                {st.session_state.breathing_rate:.2f}
                m³/h /
...
with st.expander(
    ...
    if ri < 0.1:
        st.info(
            "Forced-air momentum is likely to dominate "
            "over buoyancy."
        )
